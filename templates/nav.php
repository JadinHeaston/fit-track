<nav>
	...
	<ul>
		<li>
			<a href="<?php echo APP_ROOT; ?>folder/endpoint.php" hx-get="<?php echo APP_ROOT; ?>folder/endpoint.php" hx-select="main" hx-target="main" hx-swap="outerHTML" hx-push-url="true">TBD</a>
		</li>
	</ul>
</nav>